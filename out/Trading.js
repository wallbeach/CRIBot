...
var Trading = /** @class */ (function () {
    ...
    Trading.prototype.createMarketBuyOrder = function (instrument, notional, ticker, buyQuantity) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        ask = ticker.k;
                        minimum = ask / Math.pow(10, instrument.quantity_decimals);
                        if (notional < minimum * 1.1) {
                            console.log("\u001B[1;31m [Alert] Minimum Order size not reached [min. " + (minimum * 1.1).toFixed(3) + " USDT]");
                            return [2 /*return*/];
                        }
                        return [4 /*yield*/, svc.createMarketBuyOrder(instrument.instrument_name, notional)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Trading.prototype.createMarketSellOrder = function (instrument, quantity, sellValue) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, svc.createMarketSellOrder(instrument.instrument_name, quantity)];
                    case 1:
                        _a.sent();
